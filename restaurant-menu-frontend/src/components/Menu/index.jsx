...
const Menu = ({ isOpen, onClose }) => {
	return (
		<div
			...
			} fixed lg:static inset-0 z-50 lg:z-auto bg-[rgba(0,0,0,0.5)] lg:bg-transparent`}
		>
			<div className='max-w-full p-4 lg:p-0 flex flex-col lg:flex-row lg:items-center absolute lg:static inset-y-0 right-0 gap-6 lg:gap-12 bg-light-50 dark:bg-dark-50 transition-colors'>
				<IconButton
					isHidden={!isOpen}
