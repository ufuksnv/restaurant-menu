const CategoryCard = ({ title, image, className, onClick }) => {
	return (
		<button type='button' onClick={onClick}>
			<div
				className={`relative w-40 p-4 flex flex-col items-center gap-4 overflow-hidden rounded-2xl shadow-md bg-light-50 dark:bg-dark-100 sm:dark:bg-dark-50 transition-colors ${className}`}
			>
				<img
